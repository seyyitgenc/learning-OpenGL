...
int main()
{
    ...
    // todo: load shaders
    Shader shader(
        FileSystem::getPath("bin/shaders/5.advanced_lighting/5.5.lighting.vs").c_str(), 
        FileSystem::getPath("bin/shaders/5.advanced_lighting/5.5.lighting.fs").c_str());

    Shader hdrShader(
        FileSystem::getPath("bin/shaders/5.advanced_lighting/5.5.hdr.vs").c_str(), 
        FileSystem::getPath("bin/shaders/5.advanced_lighting/5.5.hdr.fs").c_str());
