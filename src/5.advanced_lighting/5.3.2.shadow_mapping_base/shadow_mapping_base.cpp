...
int main()
{
    ...
    // -------------------------
    Shader simpleDepthShader(FileSystem::getPath("bin/shaders/5.advanced_lighting/simpleDepthShader.vs").c_str(),
                             FileSystem::getPath("bin/shaders/5.advanced_lighting/simpleDepthShader.fs").c_str());
    Shader debugDepthQuad(FileSystem::getPath("bin/shaders/5.advanced_lighting/debugDepthQuad.vs").c_str(),
                          FileSystem::getPath("bin/shaders/5.advanced_lighting/debugDepthQuad.fs").c_str());
    Shader shader(FileSystem::getPath("bin/shaders/5.advanced_lighting/shadowMappingBase.vs").c_str(),
                  FileSystem::getPath("bin/shaders/5.advanced_lighting/shadowMappingBase.fs").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, depthMap);
        // if (isPerspective)
        //     std::cout << "Perspective depth map" << std::endl;
        // else
        //     std::cout << "Ortho depth map" << std::endl;
        // renderQuad();
