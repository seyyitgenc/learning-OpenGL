...
int main()
{
    ...
    // shaders
    Shader ourShader(FileSystem::getPath("bin/shaders/5.advanced_lighting/parallax_mapping.vs").c_str(),
                     FileSystem::getPath("bin/shaders/5.advanced_lighting/parallax_mapping.fs").c_str());
    ...
    unsigned int diffuseMap = loadTexture(FileSystem::getPath("bin/resources/textures/bricks2.jpg").c_str());
    unsigned int normalMap = loadTexture(FileSystem::getPath("bin/resources/textures/bricks2_normal.jpg").c_str());
    unsigned int depthMap = loadTexture(FileSystem::getPath("bin/resources/textures/bricks2_disp.jpg").c_str());
