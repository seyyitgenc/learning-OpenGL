...
int main() {
    ...
    // -------------------------
    Shader shader("shaders/4.advanced_opengl/1.2.blending.vs", "shaders/4.advanced_opengl/1.2.blending.fs");
    ...
    unsigned int windowsTexture = loadTexture(FileSystem::getPath("resources/textures/window.png").c_str());
    ...
    /* // NOTE don't break the order
        1. draw all opaque objects first
        2. sort all the transperant objects
