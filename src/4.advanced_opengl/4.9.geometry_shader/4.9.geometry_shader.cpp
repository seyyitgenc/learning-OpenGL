...
int main()
{
    ...
    // -------------------------
    Shader shader(FileSystem::getPath("bin/shaders/4.advanced_opengl/9.2.geometry_shader.vs").c_str(),
                  FileSystem::getPath("bin/shaders/4.advanced_opengl/9.2.geometry_shader.gs").c_str(),
                  FileSystem::getPath("bin/shaders/4.advanced_opengl/9.2.geometry_shader.fs").c_str());
